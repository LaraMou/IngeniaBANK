...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "IngeniaBANK logo"));
        logoLayout.add(new H1("IngeniaBANK"));
    ...
    private Component[] createMenuItems() {
        return new Tab[]{createTab("Inicio", InicioView.class), createTab("About", AboutView.class),
                createTab("Card List", CardListView.class), createTab("Cuentas ", CuentasView.class),
                createTab("Tarjetas", TarjetasView.class), createTab("Movimientos", MovimientosView.class),
                createTab("Balance", BalanceView.class), createTab("Master-Detail", MasterDetailView.class)};
    }
